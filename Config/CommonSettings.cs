...
internal class CommonSettings : ModSettingsCategory
{
   ...
   public CommonSettings(string filePath, LanguageConfig lng) 
      : base("Common", filePath, lng)
   {
      _logLevel = CreateEntry("LogLevel", AlternativeCameraMod.LogLevel.Error, 
         "Logging level, output in MelonLoader console\n" +
         "Error, Warning, Information, Debug, Verbose");
      _language = CreateEntry("Language", "default", 
